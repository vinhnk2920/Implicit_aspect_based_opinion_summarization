...
```
```
cd fairseq/fairseq/modules
```

```
cp adaptive_input.py /home/s2310434/research/Opinion-Summarization/code/fairseq/modules/
```

```
cp quant_noise.py /home/s2310434/research/Opinion-Summarization/code/fairseq/modules/
```
```
cp -r audio /home/s2310434/research/Opinion-Summarization/code/fairseq/data/
```

```
cp ~/research/fairseq/fairseq/data/data_utils.py /home/s2310434/research/Opinion-Summarization/code/fairseq/data/data_utils.py
```


```
cp ~/research/fairseq/fairseq/data/text_compressor.py /home/s2310434/research/Opinion-Summarization/code/fairseq/data/text_compressor.py
```

## Step 3: Synthetic training data creation
Run the following command to create synthetic training data, specifying the dataset type (e.g yelp):

```
python code/train_condense.py -mode=train -data_type=yelp
```
