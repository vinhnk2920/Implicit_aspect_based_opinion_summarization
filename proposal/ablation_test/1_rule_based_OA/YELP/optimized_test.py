...
model_path = "trained_model_1M_random_rule_base"
...
for entry in test_data:
    ...
    sentences = [sent.text.strip() for review in reviews.values() for sent in nlp.pipe([review])]
    ...
    # Generate summary
    with torch.no_grad():
        predicted_summary = model.generate(oas_input, iss_input, max_length=256, min_length=120, num_beams=5)
