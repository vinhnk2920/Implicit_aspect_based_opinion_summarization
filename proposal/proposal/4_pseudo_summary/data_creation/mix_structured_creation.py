...
# Chạy chương trình
input_file = "results/1M_random/mix_structured_data_sentiment_1M_random_keep_OA.json"
output_file = "results/1M_random/mix_structured_data_proposal_1M_random_keep_OA.json"
