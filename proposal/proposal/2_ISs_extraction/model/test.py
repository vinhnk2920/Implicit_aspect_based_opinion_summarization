...
for entry in test_data:
    ...
    # Generate summary using checkpoint
    with torch.no_grad():
        predicted_summary = checkpoint(model.generate, oas_input, iss_input, max_length=256, num_beams=5)
    ...
    # Xóa các biến không cần thiết và giải phóng bộ nhớ
    del oas_input, iss_input, predicted_summary
